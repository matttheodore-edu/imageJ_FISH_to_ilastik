...
run("Export HDF5", "select=[nickpath] exportpath=[C:/Users/MicrobeJ/Documents/Zenglab/Matthew Theodore/Data/RNA FISH/2022.12.19_startingfromscratch/scratchdata/.h5] datasetname=data compressionlevel=0 input=[nickinput]");
